import { makeSchema, queryType, mutationType, asNexusMethod, objectType, enumType, arg, stringArg, idArg, nonNull } from 'nexus';
...
export const schema = makeSchema({
    ...
    outputs: {
        ...
        typegen: path.join(process.cwd(), 'graphql\\generated\\nexus.d.ts')
    },
    contextType: {
